    ...
    return (
        <nav className="flex items-center justify-between flex-wrap p-6 container mx-auto">
            ...
            <div className="w-full block lg:flex lg:items-center lg:w-auto">
                ...
                <a href="/projects" className={`block mt-4 lg:inline-block lg:mt-0 hover:text-gray-200 mx-4 ${page === 'projects' ? 'font-bold' : 'font-normal'}`}>
                    Projects
                </a>
                <a href="/blogs" className={`block mt-4 lg:inline-block lg:mt-0 hover:text-gray-200 mx-4 ${page === 'blogs' ? 'font-bold' : 'font-normal'}`}>
                    Blog
                </a>
                <a href="/curriculum-vitae" className={`block mt-4 lg:inline-block lg:mt-0 hover:text-gray-200 ml-4 ${page === 'cv' ? 'font-bold' : 'font-normal'}`}>
                    Curriculum Vitae
                </a>
                </div>
                {/* <div>
